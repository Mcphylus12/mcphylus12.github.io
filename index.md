...
My University modules included writing 3D applications using OpenGL, Embedded systems with C and Using Design Patterns to build a reusable mobile framework for Android.

As a software engineer I am an advocate of clean object oriented programming using SOLID design principles and TDD. For me the best experience is having a colleague send you a message just saying thanks for writing that one class in a way that made his life easier.
